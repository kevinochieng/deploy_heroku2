...
# Load the dataset
data = pd.read_csv(r'C:\Users\ADMIN\Desktop\Codes\deployment2\data\data.csv')
...
# Export model
joblib.dump(pipe, gzip.open(r'C:\Users\ADMIN\Desktop\Codes\deployment2\model\model_binary.dat.gz', "wb"))